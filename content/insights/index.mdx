...
<Callout type="info">
  All data is collected automatically based on the entries you create. There is
  nothing to configure -- just write, and Reflecto handles the rest.
</Callout>
...
<Tabs items={["Journal", "Dreams", "Highlights", "Tags", "People", "Wisdom"]}>
  <Tabs.Tab>
    Shows stats and charts for **journal entries** only. This is the default
    view.
  </Tabs.Tab>
  <Tabs.Tab>
    Filters to **dream entries** so you can see how often you record aspirations
    and goals.
  </Tabs.Tab>
  <Tabs.Tab>
  ...
  <Tabs.Tab>
    Shows tag-related analytics across **all entry types**, including your most
    common themes.
  </Tabs.Tab>
  <Tabs.Tab>
    Shows people-related analytics across **all entry types**, including your
...
<Callout>
  The heatmap always displays overall activity regardless of which tab is
  selected. Stats and charts update to reflect the active filter.
</Callout>
...
<Callout type="info">
  If you see a "Gathering insights..." message with a progress indicator, keep
  writing. Charts unlock once you reach the 5-entry threshold for the selected
  tab.
</Callout>
