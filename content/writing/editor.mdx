...
<Tabs items={['Drag & Drop', 'Paste', 'Toolbar']}>
  ...
  <Tabs.Tab>
    Copy an image (screenshot, web image) and press `Ctrl/Cmd + V` in the editor. The image uploads and appears at the cursor.
  </Tabs.Tab>
  <Tabs.Tab>
    Click the image button in the toolbar, select a file from your device, and it inserts at the cursor position.
  </Tabs.Tab>
</Tabs>
