...
<Callout type="info">
  Reflecto limits you to one journal entry per day. This keeps your daily
  reflection focused and prevents fragmentation.
</Callout>
...
<Callout>
  Other entry types (highlights, ideas, notes, dreams, wisdom) are not limited
  -- you can create as many as you need on any date.
</Callout>
...
<Callout type="info">
  Mood tracking is optional but provides valuable patterns. You can set moods
  retroactively by editing past entries.
</Callout>
